...
class MainView {
	...
	/**
    * Visar information på förstasidan om man inte är inloggad, vilken returneras.
    * 
    * @return String HTML
    */
	public function ShowMainNotLoggedIn() {
		return "<div id='mainViewContainer'>
					...
					<h3 class='mainView'>How does Collaborage work?</h3>
	...
	/**
    * Visar information på förstasidan om man är inloggad, vilken returneras.
    *
    ...
    * @return String HTML
    */
	public function ShowRegisterView($register) {
